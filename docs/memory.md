...
the [Context](context.md) windows or summarizes old turns away, whatever the agent
...
Three tools are wired into the default `Config.jo`:
...
| **[skills](skills.md)** | you | on demand (the agent reads) | static |
