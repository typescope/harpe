...
[conversational](conversational-agent.md) one — it just wakes on an incoming request instead
...
[how a turn works](concepts.md#how-a-turn-works) for the full picture.

## Next steps

- [Monitoring agent](monitoring-agent.md) — same project, applied to a scheduled monitor.
- [Conversational agent](conversational-agent.md) — if you skipped it, it's the gentlest intro.
- [Create a custom capability](create-custom-capabilities.md) — wrap your own internal API as a capability.
