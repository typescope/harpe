...
see [Concepts](/tutorial/concepts/).
...
[the compile-time sandbox](/tutorial/concepts/#the-compile-time-sandbox).
...
- [Concepts](/tutorial/concepts/) — how a turn works and why the capability grant is the whole
  security boundary.
