...
This is the same Jo project as the [conversational](/tutorial/conversational-agent/) and
[request-driven](/tutorial/request-driven-agent/) agents — it just wakes on a **schedule** instead
